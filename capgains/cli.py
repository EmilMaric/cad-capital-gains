...
@capgains.command(help=("Show entries from the transactions file in a "
                        "tabular format. Supports both CSV and JSON input files. "
...
def show(transactions_file, show_exchange_rate, tickers, format):
    ...
    capgains_show(transactions, show_exchange_rate, tickers=tickers, output_format=format)


@capgains.command(help=("Calculates capital gains from the transactions "
                        "file. Supports both CSV and JSON input files. "
